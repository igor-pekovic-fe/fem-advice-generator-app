...
let idEl = document.querySelector(".advice-card__id");
let adviceEl = document.querySelector(".advice-card__advice");
let dividerEl = document.querySelector(".advice-card__divider");
